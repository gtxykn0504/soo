  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background to-muted">
      <Card className="w-full max-w-md transition-all duration-200 hover:shadow-lg">
        <CardHeader>
          <CardTitle className="text-center text-2xl font-bold">Box访问助手</CardTitle>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative group">
              <Input
                ...
                placeholder="请输入提取码"
                className="pr-10 transition-all duration-200 border-2 h-12 text-lg"
                autoFocus
                disabled={isLoading}
              />
              {input && (
            ...
            {previewUrl && (
              <div className="text-sm text-muted-foreground break-all animate-fade-in">
                ...
                <p className="font-mono bg-muted p-2 rounded">{previewUrl}</p>
              </div>
            )}
